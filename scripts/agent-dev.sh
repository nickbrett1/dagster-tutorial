...
# "dagster-tutorial-dev" (the repo name plus the "-dev"
...
# than adding a second one - a stale "dagster-tutorial-dev" is overwritten by
...
PROJECT_NAME="dagster-tutorial"
AGENT_NAME="dagster-tutorial-dev"
WORKSPACE="/workspaces/dagster-tutorial"
...
if [ -x "/workspaces/dagster-tutorial/scripts/agent-dev.sh" ]; then
  "/workspaces/dagster-tutorial/scripts/agent-dev.sh" start >/dev/null 2>&1 || true
fi
POST_START_HOOK
}
